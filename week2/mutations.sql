...
-- A: Create an intermediate table to join the two tables
...
ADD CONSTRAINT fk_employees_employees_categories
...
-- place it in the blank space below.
ALTER TABLE employees_categories
ADD CONSTRAINT fk_categories_employees_categories
